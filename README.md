...
- `INCUS_WEB_TERMINAL_URL`: optional dashboard terminal link. For the SWAG-backed host web app, set this to `/terminal/` when SWAG routes `/terminal/` and `/ws` to the Ghostty upstream.
